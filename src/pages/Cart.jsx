        ...
        {isLoading ? (
          ...
          <>
              ...
              >
                ...
                <div className="col-span-12 lg:col-span-10 detail w-full lg:pl-3">
                  <div className="flex items-center justify-between w-full mb-4">
                    ...
                    <button
                      onClick={() => {
                        dispatch(removeCartItem({ productId:item.id }));
                      }}
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-4">
                      <button
                        onClick={() =>
                          dispatch(decreaseCartItemQuantity({ productId:item.id  }))
                        }
                      ...
                      <button
                        onClick={() =>
                          dispatch(increaseCartItemQuantity({ productId:item.id  }))
                        }
                        className="group rounded-[50px] border border-gray-200 shadow-sm shadow-transparent p-2.5 flex items-center justify-center bg-white transition-all duration-500 hover:shadow-gray-200 hover:bg-gray-50 hover:border-gray-300 focus-within:outline-gray-300"
                      >
                        <svg
            ...
            <div className="max-lg:max-w-lg max-lg:mx-auto">
              <p className="font-normal text-base leading-7 text-gray-100 text-center mb-5 mt-6">
